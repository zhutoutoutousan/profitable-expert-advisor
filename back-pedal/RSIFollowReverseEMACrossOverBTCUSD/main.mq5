...
input int    InpMagicNumberRSIFollow = 9991; // Magic Number RSI Follow
input int    InpMagicNumberRSIReverse = 9992;// Magic Number RSI Reverse
input int    InpMagicNumberEMACross = 9993;  // Magic Number EMA Cross
